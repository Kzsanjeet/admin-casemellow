...
const EditCustomizeForm: React.FC<ProductProps> = ({ productDetails }) => {
  ...
  const handleCoverTypeChange = (selectedType: string) => {
    setFormData((prev) => ({
      ...prev,
      ...
      <Card className="w-full max-w-4xl shadow-lg">
        ...
        <CardContent>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Cover Types - Now as Radio Buttons */}
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">
                Cover Type
              </label>
                ...
                {coverTypes.map((type) => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => handleCoverTypeChange(type)}
                      className="rounded-full border-gray-300 text-gray-900 focus:ring-gray-400"
                      required
                    />
                    <span className="text-sm text-gray-700">{type}</span>
                  </label>
